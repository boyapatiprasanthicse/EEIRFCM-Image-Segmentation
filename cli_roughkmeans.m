clear all;
close all;
img=imread('F:\anupama\ppt\softsets\softsets\images\clinical data\20Normals_T1_analyze\IBSR_02\ana2_original\ana_2185.jpg');
...
peaks=cli_hist_peak(img);
cluster_stats(1)=peaks(1);
cluster_stats(2)=peaks(2);
cluster_stats(3)=peaks(3);
cluster_stats(4)=peaks(4);
